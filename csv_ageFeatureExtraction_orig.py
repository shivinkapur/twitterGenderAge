...
noOfRows=0
filtered_des=[[[] for x in xrange(1)] for x in xrange(10000)]
tweet_words=[[[] for x in xrange(1)] for x in xrange(10000)]
des_words=[[[] for x in xrange(1)] for x in xrange(10000)]
name_words=[[[] for x in xrange(1)] for x in xrange(10000)]
word_tokenizer = RegexpTokenizer(r'\w+')
this_name=""
UniqueNamesCount=0
	...
	# 	row = f.readline()  
			...
			while UniqueNamesCount!=2:
				...
				#print row[2]
					...
					tokenized_words1 = word_tokenizer.tokenize(row[3])#3
